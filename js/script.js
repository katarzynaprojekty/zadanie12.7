document.addEventListener('DOMContentLoaded', function() {
    ...
    /*
    // ZADANIE DLA CHĘTNYCH obiekt board --> klasa Board
    function Board (name) {
        var self = this;
    ...
    Board.prototype = {
        addBoard: function(card) {
            this.element.querySelector('div').appendChild(column.element);
        },
    ...
    */
    // the end -- ZADANIE DLA CHĘTNYCH -- the end
